# Generated by Django 3.2.3 on 2022-01-19 15:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_to', models.CharField(default='custom', max_length=20, null=True)),
                ('nationality', models.CharField(default='other', max_length=20)),
                ('info', models.TextField()),
                ('stattus', models.BooleanField(db_index=True, default=True)),
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('updated_time', models.DateTimeField(auto_now=True)),
            ],
            options={
                'unique_together': {('video_name', 'video_type', 'from_to', 'nationality')},
            },
        ),
        migrations.CreateModel(
            name='VideoSub',
